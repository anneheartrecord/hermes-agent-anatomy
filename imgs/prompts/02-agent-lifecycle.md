...
style: notion
aspect: 16:9
output: /Users/annesheartrecord/Desktop/hermes-agent-anatomy/imgs/02-agent-lifecycle.png
---

SCENE: Agent 生命周期: 构造→初始化→循环→清理, 四个阶段从左到右排列, 每个阶段一个圆角矩形, faceless figure walking through
...
Add one short Chinese quote in a natural handwritten style near the bottom: "构造是起点，清理是责任"
