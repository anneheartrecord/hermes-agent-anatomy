...
style: notion
aspect: 16:9
output: /Users/annesheartrecord/Desktop/hermes-agent-anatomy/imgs/08-rl-pipeline.png
---

SCENE: RL闭环: Agent使用→轨迹采集→压缩→RL训练→更好的模型→更好的Agent, 环形
...
Add one short Chinese quote in a natural handwritten style near the bottom: "闭环是Hermes的独门武器"
